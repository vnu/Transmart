...
import com.android.transmart.providers.QueuedCheckinsContentProvider;
    ...
    if (reference != null) {
      try {
        ...
        if (response.getStatusLine().getReasonPhrase().equals(LocationConstants.PLACES_CHECKIN_OK_STATUS)) {
          long lastCheckin = sharedPreferences.getLong(LocationConstants.SP_KEY_LAST_CHECKIN_TIMESTAMP, 0);
