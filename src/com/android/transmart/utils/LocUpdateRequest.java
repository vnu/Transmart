 ...
 */
public abstract class LocUpdateRequest {
	protected LocationManager locationManager;

	protected LocUpdateRequest(LocationManager locationManager) {
	 ...
	 * updates. The minimum time and distance for passive updates will
