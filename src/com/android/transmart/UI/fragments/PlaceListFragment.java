...
import com.android.transmart.PlaceActivity;
...
public class PlaceListFragment extends ListFragment implements LoaderCallbacks<Cursor> {
  ...
  public void onListItemClick(ListView l, View v, int position, long theid) {
    ...
    serviceIntent.putExtra(LocationConstants.EXTRA_KEY_REFERENCE, reference);
    serviceIntent.putExtra(LocationConstants.EXTRA_KEY_ID, id);
    serviceIntent.putExtra(LocationConstants.EXTRA_KEY_FORCEREFRESH, true);        
