  ...
  public void onReceive(Context context, Intent intent) {
    ...
    if (intent.hasExtra(providerEnabledKey)) {
      if (!intent.getBooleanExtra(providerEnabledKey, true)) {
        Intent providerDisabledIntent = new Intent(LocationConstants.ACTIVE_LOCATION_UPDATE_PROVIDER_DISABLED);
    ...
    if (intent.hasExtra(locationKey)) {
      ...
      updateServiceIntent.putExtra(LocationConstants.EXTRA_KEY_FORCEREFRESH, true);
