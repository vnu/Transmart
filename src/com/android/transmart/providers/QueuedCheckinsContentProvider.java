...
public class QueuedCheckinsContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.android.transmart.provider.checkins/checkins");
  ...
  static {
   ...
   uriMatcher.addURI("com.android.transmart.provider.checkins", "checkins", CHECKINS);
   uriMatcher.addURI("com.android.transmart.provider.checkins", "checkins/*", CHECKIN_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      ...
      case CHECKIN_ID: return "vnd.android.cursor.item/vnd.android.transmart.checkin";
