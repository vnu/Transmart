...
public class PlacesContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.android.transmart.provider.places/places");
  ...
  static {
   ...
   uriMatcher.addURI("com.android.transmart.provider.places", "places", PLACES);
   uriMatcher.addURI("com.android.transmart.provider.places", "places/*", PLACE_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      ...
      case PLACE_ID: return "vnd.android.cursor.item/vnd.android.transmart.place";
