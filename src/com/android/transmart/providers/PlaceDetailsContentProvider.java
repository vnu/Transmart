...
package com.android.transmart.providers;
...
public class PlaceDetailsContentProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://com.android.transmart.provider.placedetails/places");
  ...
  static {
   ...
   uriMatcher.addURI("com.android.transmart.provider.placedetails", "places", PLACES);
   uriMatcher.addURI("com.android.transmart.provider.placedetails", "places/*", PLACE_ID);
  }
  ...
  public String getType(Uri uri) {
    switch (uriMatcher.match(uri)) {
      case PLACES: return "vnd.android.cursor.dir/vnd.android.transmart.placedetail";
      case PLACE_ID: return "vnd.android.cursor.item/vnd.android.transmart.placedetail";
