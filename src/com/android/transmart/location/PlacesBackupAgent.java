...
public class PlacesBackupAgent extends BackupAgentHelper {
  ...
  public void onCreate() {
    SharedPreferencesBackupHelper helper = new SharedPreferencesBackupHelper(this, LocationConstants.SHARED_PREFERENCE_FILE);
    addHelper(LocationConstants.SP_KEY_FOLLOW_LOCATION_CHANGES, helper);
