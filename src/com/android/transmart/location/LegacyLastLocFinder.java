...
public class LegacyLastLocFinder implements ILastLocationFinder {
	protected static String TAG = "LegacyLastLocFinder";
	...
	public LegacyLastLocFinder(Context context) {
